...
class HopeTestingPage extends StatefulWidget {

  const HopeTestingPage({Key? key}) : super(key: key);

  @override
  State<HopeTestingPage> createState() => _HopeTestingPageState();
}

class _HopeTestingPageState extends State<HopeTestingPage> {
                ...
                Expanded(
                  child: Row(
                    children: [
                      ...
                      IconButton(
                          onPressed: (){
                            _messageWidget=[..._messageWidget,HopeEffect(
