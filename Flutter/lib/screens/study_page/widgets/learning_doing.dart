...
class LearningDoing extends StatefulWidget {
  ...
  @override
  State<LearningDoing> createState() => _LearningDoingState();
}

class _LearningDoingState extends State<LearningDoing> {
  ...
  void initState() {
    super.initState();
    totalSeconds=widget.learningModel.totalMinutes*60;
    startTimer();
  }
  ...
  void startTimer(){
    ...
    totalTimer=Timer(
        Duration(seconds: totalSeconds),() async{
          ...
          await widget.provider.addTransaction(widget.learningModel.id);
          await widget.provider.addLearningPoints(skipped: false);
