...
class PasswordToDeleteHabit extends StatefulWidget {

  final String id;
  final HabitsProvider provider;
  const PasswordToDeleteHabit({
  ...
  @override
  State<PasswordToDeleteHabit> createState() => _PasswordToDeleteHabitState();
}

class _PasswordToDeleteHabitState extends State<PasswordToDeleteHabit> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Habit Is Very Sensitive Data To Delete..",
                    ...
                    CustomBlueButton(
                        ...
                        onPressed: () async{
                          if(_formKey.currentState!.validate()){
                            ...
                            await widget.provider.deleteFunction(widget.id).then((value) {
                              DeletedNotification().dispatch(context);
