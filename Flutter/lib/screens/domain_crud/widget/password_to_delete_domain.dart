...
class PasswordToDeleteDomain extends StatefulWidget {

  final String id;
  final DomainProvider provider;
  const PasswordToDeleteDomain({
  ...
  @override
  State<PasswordToDeleteDomain> createState() => _PasswordToDeleteDomainState();
}

class _PasswordToDeleteDomainState extends State<PasswordToDeleteDomain> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Domain Is Very Sensitive Data To Delete..",
